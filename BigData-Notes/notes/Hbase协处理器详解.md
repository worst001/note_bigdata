...
![hbase-coprocessor](/BigData-Notes/pictures/hbase-coprocessor.png)
...
![RegionObserver](/BigData-Notes/pictures/RegionObserver.png)
...
![RegionObservers-works](/BigData-Notes/pictures/RegionObservers-works.png)
...
![hbase-cp-hdfs](/BigData-Notes/pictures/hbase-cp-hdfs.png)
...
![hbase-cp-load](/BigData-Notes/pictures/hbase-cp-load.png)
...
![hbase-cp-helloworld](/BigData-Notes/pictures/hbase-cp-helloworld.png)
...
![hbase-cp-lisi](/BigData-Notes/pictures/hbase-cp-lisi.png)
...
![hbase-co-unload](/BigData-Notes/pictures/hbase-co-unload.png)
...
![hbase-unload-test](/BigData-Notes/pictures/hbase-unload-test.png)
