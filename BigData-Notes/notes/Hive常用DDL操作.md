...
![hive-show-database](/BigData-Notes/pictures/hive-show-database.png)
...
![hive-external-table](/BigData-Notes/pictures/hive-external-table.png)
...
![hive-select-emp](/BigData-Notes/pictures/hive-select-emp.png)
