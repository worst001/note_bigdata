...
![sql-hive-arch](/BigData-Notes/pictures/sql-hive-arch.png)
...
![spark-dataFrame+RDDs](/BigData-Notes/pictures/spark-dataFrame+RDDs.png)
...
![spark-unifed](/BigData-Notes/pictures/spark-unifed.png)
...
![spark-运行安全](/BigData-Notes/pictures/spark-运行安全.png)
...
![spark-运行时类型安全](/BigData-Notes/pictures/spark-运行时类型安全.png)
...
![spark-structure-api](/BigData-Notes/pictures/spark-structure-api.png)
...
![spark-Logical-Planning](/BigData-Notes/pictures/spark-Logical-Planning.png)
...
![spark-Physical-Planning](/BigData-Notes/pictures/spark-Physical-Planning.png)
