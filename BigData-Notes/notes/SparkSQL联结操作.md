...
![spark-sql-NATURAL-JOIN](/BigData-Notes/pictures/spark-sql-NATURAL-JOIN.png)
...
![spark-Big-table–to–big-table](/BigData-Notes/pictures/spark-Big-table–to–big-table.png)
...
![spark-Big-table–to–small-table](/BigData-Notes/pictures/spark-Big-table–to–small-table.png)
