...
![scala-分区数](/BigData-Notes/pictures/scala-分区数.png)
...
![spark-reducebykey](/BigData-Notes/pictures/spark-reducebykey.png)
...
![spark-窄依赖和宽依赖](/BigData-Notes/pictures/spark-窄依赖和宽依赖.png)
...
![spark-DAG](/BigData-Notes/pictures/spark-DAG.png)
