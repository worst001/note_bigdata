...
![spark-pi](/BigData-Notes/pictures/spark-pi.png)
...
![spark-Standalone-web-ui](/BigData-Notes/pictures/spark-Standalone-web-ui.png)
...
![spark-内存不足2](/BigData-Notes/pictures/spark-内存不足2.png)
...
![spark-内存不足](/BigData-Notes/pictures/spark-内存不足.png)
